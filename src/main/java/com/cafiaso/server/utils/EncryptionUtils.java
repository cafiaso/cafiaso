...
public class EncryptionUtils {
     ...
     */
    public static byte[] decrypt(byte[] data, SecretKey secretKey) throws IOException {
        return operate(data, Cipher.DECRYPT_MODE, secretKey);
    }
     ...
     */
    public static byte[] encrypt(byte[] data, SecretKey secretKey) throws IOException {
        return operate(data, Cipher.ENCRYPT_MODE, secretKey);
    }
     ...
     */
    private static byte[] operate(byte[] data, int mode, SecretKey secretKey) throws IOException {
        try {
